...
def skin_image(event,userid,color):
    ...
    if color == 1:
        ...
        #色相を上げる
        hsv_8[:, :, 0] = np.where((hsv_7[:, :, 2]>=0) & (hsv_7[:, :, 2]<30) ,hsv_7[:, :, 0] + 60 ,hsv_7[:, :, 0])
        hsv_9[:, :, 0] = np.where((hsv_8[:, :, 2]>30) & (hsv_8[:, :, 2]<60) ,hsv_8[:, :, 0] + 60 ,hsv_8[:, :, 0])#150~180
        hsv_10[:, :, 0] = np.where((hsv_9[:, :, 2]>60) & (hsv_9[:, :, 2]<100) ,hsv_9[:, :, 0]+60 ,hsv_9[:, :, 0])#160~190
