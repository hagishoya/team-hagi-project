...
def skin_image(event,userid,color):
    ...
    if color == 1:
        ...
        #彩度を上げる
        hsv_5[:, :, 1] = np.where((hsv_4[:, :, 2]>=0) & (hsv_4[:, :, 2]<30) ,hsv_4[:, :, 1] + 120 ,hsv_4[:, :, 1])
        hsv_6[:, :, 1] = np.where((hsv_5[:, :, 2]>30) & (hsv_5[:, :, 2]<60) ,hsv_5[:, :, 1] + 120 ,hsv_5[:, :, 1])
        hsv_7[:, :, 1] = np.where((hsv_6[:, :, 2]>60) & (hsv_6[:, :, 2]<90) ,hsv_6[:, :, 1] + 120 ,hsv_6[:, :, 1])

        


        #色相を上げる
        hsv_8[:, :, 0] = np.where((hsv_7[:, :, 2]>=0) & (hsv_7[:, :, 2]<30) ,hsv_7[:, :, 0] +120 ,hsv_7[:, :, 0])
        hsv_9[:, :, 0] = np.where((hsv_8[:, :, 2]>30) & (hsv_8[:, :, 2]<60) ,hsv_8[:, :, 0] +120 ,hsv_8[:, :, 0])#150~180
        hsv_10[:, :, 0] = np.where((hsv_9[:, :, 2]>60) & (hsv_9[:, :, 2]<90) ,hsv_9[:, :, 0]+120 ,hsv_9[:, :, 0])#160~190


        #明度を上げる
        hsv_11 = np.copy(hsv_10)
        hsv_11[:, :, 2] = np.where((hsv_10[:, :, 2]>=0) & (hsv_10[:, :, 2]<30) ,hsv_10[:, :, 2] + 140 ,hsv_10[:, :, 2])#140~170
        
        hsv_12 = np.copy(hsv_11)
        hsv_12[:, :, 2] = np.where((hsv_11[:, :, 2]>30) & (hsv_11[:, :, 2]<60) ,hsv_11[:, :, 2] + 120 ,hsv_11[:, :, 2])#150~180

        hsv_13 = np.copy(hsv_12)
        hsv_13[:, :, 2] = np.where((hsv_12[:, :, 2]>60) & (hsv_12[:, :, 2]<90) ,hsv_12[:, :, 2] + 100 ,hsv_12[:, :, 2])#160~190
