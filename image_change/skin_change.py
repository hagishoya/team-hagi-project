...
def skin_image(event,userid,color):
    ...
    if color == 1:
        ...
        #彩度をあげる
        hsv_8[:, :, 1] = np.where(((hsv_7[:, :, 2]>140) & (hsv_7[:, :, 2]<170)) ,hsv_7[:, :, 1] + 200 ,hsv_7[:, :, 1],)#& (hsv_4[:, :, 1]<20) 
        hsv_9[:, :, 1] = np.where(((hsv_8[:, :, 2]>150) & (hsv_8[:, :, 2]<180)) ,hsv_8[:, :, 1] + 200,hsv_8[:, :, 1],)
        hsv_10[:, :, 1] = np.where(((hsv_9[:, :, 2]>160) & (hsv_9[:, :, 2]<190)) ,hsv_9[:, :, 1] + 200 ,hsv_9[:, :, 1],)
