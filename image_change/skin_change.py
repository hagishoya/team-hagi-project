...
def skin_image(event,userid,color):
    ...
    if color == 1:
        ...
        hsv_11[:, :, 2] = np.where((hsv_10[:, :, 2]>=0) & (hsv_10[:, :, 2]<30) ,hsv_10[:, :, 2] + 120 ,hsv_10[:, :, 2])#140~170
        
        hsv_12 = np.copy(hsv_11)
        hsv_12[:, :, 2] = np.where((hsv_11[:, :, 2]>30) & (hsv_11[:, :, 2]<60) ,hsv_11[:, :, 2] + 100 ,hsv_11[:, :, 2])#150~180

        hsv_13 = np.copy(hsv_12)
        hsv_13[:, :, 2] = np.where((hsv_12[:, :, 2]>60) & (hsv_12[:, :, 2]<90) ,hsv_12[:, :, 2] + 80 ,hsv_12[:, :, 2])#160~190
