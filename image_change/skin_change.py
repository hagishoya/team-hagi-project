...
def skin_image(event,userid,color):
    ...
    if color == 1:
        ...
        hsv_7[:, :, 1] = np.where((hsv_6[:, :, 2]>60) & (hsv_6[:, :, 2]<120) ,hsv_6[:, :, 1] + 230 ,hsv_6[:, :, 1])
        ...
        hsv_10[:, :, 0] = np.where((hsv_9[:, :, 2]>60) & (hsv_9[:, :, 2]<120) ,hsv_9[:, :, 0]+80 ,hsv_9[:, :, 0])#160~190


        #明度を上げる
        hsv_11 = np.copy(hsv_10)
        hsv_11[:, :, 2] = np.where((hsv_10[:, :, 2]>=0) & (hsv_10[:, :, 2]<30) ,hsv_10[:, :, 2] + 180 ,hsv_10[:, :, 2])#140~170
        
        hsv_12 = np.copy(hsv_11)
        hsv_12[:, :, 2] = np.where((hsv_11[:, :, 2]>30) & (hsv_11[:, :, 2]<60) ,hsv_11[:, :, 2] + 160 ,hsv_11[:, :, 2])#150~180

        hsv_13 = np.copy(hsv_12)
        hsv_13[:, :, 2] = np.where((hsv_12[:, :, 2]>60) & (hsv_12[:, :, 2]<120) ,hsv_12[:, :, 2] + 140 ,hsv_12[:, :, 2])#160~190
