...
def skin_image(event,userid,color):
    ...
    if color == 1:
        hsv_2[:, :, 2] = np.where((hsv[:, :, 2]>0) & (hsv[:, :, 2]<30) ,hsv[:, :, 2] + 140 ,hsv[:, :, 2])#140~170
        hsv_3[:, :, 2] = np.where((hsv_2[:, :, 2]>30) & (hsv_2[:, :, 2]<60) ,hsv_2[:, :, 2] + 120 ,hsv_2[:, :, 2])#150~180
        hsv_4[:, :, 2] = np.where((hsv_3[:, :, 2]>60) & (hsv_3[:, :, 2]<90) ,hsv_3[:, :, 2] + 100 ,hsv_3[:, :, 2])#160~190
        hsv_5[:, :, 1] = np.where(((hsv_4[:, :, 2]>140) & (hsv_4[:, :, 2]<170)) & (hsv_4[:, :, 1]<50) ,hsv_4[:, :, 1] + 150 ,hsv_4[:, :, 1],)
        hsv_6[:, :, 1] = np.where(((hsv_5[:, :, 2]>150) & (hsv_5[:, :, 2]<180)) & (hsv_5[:, :, 1]<50) ,hsv_5[:, :, 1] + 150 ,hsv_5[:, :, 1],)
        hsv_7[:, :, 1] = np.where(((hsv_6[:, :, 2]>160) & (hsv_6[:, :, 2]<190)) & (hsv_6[:, :, 1]<50) ,hsv_6[:, :, 1] + 150 ,hsv_6[:, :, 1],)
