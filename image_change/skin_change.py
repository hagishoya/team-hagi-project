...
def skin_image(event,userid,color):
    ...
    if color == 1:
        ...
        hsv_5[:, :, 1] = np.where(((hsv_4[:, :, 2]>140) & (hsv_4[:, :, 2]<170)) & (hsv_4[:, :, 1]<30) ,hsv_4[:, :, 1] + 100 ,hsv_4[:, :, 1],)
        hsv_6[:, :, 1] = np.where(((hsv_5[:, :, 2]>150) & (hsv_5[:, :, 2]<180)) & (hsv_5[:, :, 1]<30) ,hsv_5[:, :, 1] + 100 ,hsv_5[:, :, 1],)
        hsv_7[:, :, 1] = np.where(((hsv_6[:, :, 2]>160) & (hsv_6[:, :, 2]<190)) & (hsv_6[:, :, 1]<30) ,hsv_6[:, :, 1] + 100 ,hsv_6[:, :, 1],)
