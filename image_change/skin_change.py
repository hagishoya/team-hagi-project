...
def skin_image(event,userid,color):
    ...
    if color == 1:
        ...
        #彩度を上げる
        hsv_5[:, :, 1] = np.where((hsv_4[:, :, 2]>=0) & (hsv_4[:, :, 2]<30) ,hsv_4[:, :, 1] + 180 ,hsv_4[:, :, 1])
        hsv_6[:, :, 1] = np.where((hsv_5[:, :, 2]>30) & (hsv_5[:, :, 2]<60) ,hsv_5[:, :, 1] + 180 ,hsv_5[:, :, 1])
        hsv_7[:, :, 1] = np.where((hsv_6[:, :, 2]>60) & (hsv_6[:, :, 2]<90) ,hsv_6[:, :, 1] + 180 ,hsv_6[:, :, 1])
        ...
        hsv_10[:, :, 0] = np.where((hsv_9[:, :, 2]>60) & (hsv_9[:, :, 2]<90) ,hsv_9[:, :, 0]+80 ,hsv_9[:, :, 0])#160~190
